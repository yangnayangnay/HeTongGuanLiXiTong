        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                if (contract != null) {
                    ...
                    FileLogger.info("ContractFinalizePanel", "uploadAttachment", "上传附件: " + fileName + ", 合同=" + conNum);
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "上传失败: " + ex.getMessage(), "错误", JOptionPane.ERROR_MESSAGE);
                FileLogger.error("ContractFinalizePanel", "uploadAttachment", "上传失败", ex);
            }
        }
    }
    ...
    private void downloadAttachment() {
        ...
        try {
            ...
            if (chooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                FileLogger.info("ContractFinalizePanel", "downloadAttachment", "下载附件: " + contract.getFileName() + ", 合同=" + conNum);
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "下载失败: " + ex.getMessage(), "错误", JOptionPane.ERROR_MESSAGE);
            FileLogger.error("ContractFinalizePanel", "downloadAttachment", "下载失败", ex);
        }
    }
}
